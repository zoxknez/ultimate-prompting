...
def main() -> int:
    ...
    if args.static:
        ...
        # All 16 stacks are migrated to lossless stack-local-sections composition and must
        # stay byte-equivalent to their v2.0.0 reference.
        success &= run_check_script("compose.py", ["--check"])
